...
Read `~/.claude/skills/evaluate/modes/brief.md` for detailed instructions on each step. Read `~/.claude/skills/evaluate/references/scope-guide.md` for depth calibration.
...
Write the full brief using the template at `~/.claude/skills/evaluate/templates/brief-template.md`.
...
1. Read `~/.claude/agents/core/architect.md` yourself
...
1. Read `~/.claude/agents/core/strategic-critic.md` yourself
2. Embed into prompt:
