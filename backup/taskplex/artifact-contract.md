...
**R** = required (blocks completion if missing/failing), **A** = advisory (produced and evaluated; red-line rule violations still block — see `~/.claude/taskplex/hardening-checks.md` → "Red-Line Rules"), **—** = not applicable
