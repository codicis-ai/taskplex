...
- Read `${CLAUDE_PLUGIN_ROOT}/skills/{skill}/evolutions.json`
- If not found, check `${CLAUDE_PLUGIN_ROOT}/skills/{skill}/SKILL.md` parent directory
- If no evolutions.json exists: "No evolutions found for {skill}."

If `--all`:
- Scan all `${CLAUDE_PLUGIN_ROOT}/skills/*/evolutions.json` files
