...
Check for `${CLAUDE_PLUGIN_ROOT}/skills/taskplex/evolutions.json`. If it exists, read it and load active evolutions into your context. These are improvements learned from past task failures and corrections — apply them throughout this task.
...
```
Read: ${CLAUDE_PLUGIN_ROOT}/skills/workflow/references/phases/init.md
```
...
```
Read: ${CLAUDE_PLUGIN_ROOT}/skills/workflow/references/phases/planning.md
```
...
```
Read: ${CLAUDE_PLUGIN_ROOT}/skills/workflow/references/phases/qa.md
```
...
```
Read: ${CLAUDE_PLUGIN_ROOT}/skills/workflow/references/phases/validation.md
```
...
- **Policy**: `${CLAUDE_PLUGIN_ROOT}/skills/workflow/references/policy.json` — quality profiles, gates, limits
- **Gates**: `${CLAUDE_PLUGIN_ROOT}/skills/workflow/references/gates.md` — canonical gate names, verdict enums, execution order
- **Artifacts**: `${CLAUDE_PLUGIN_ROOT}/skills/workflow/references/artifact-contract.md` — required artifacts by profile
- **Manifest schema**: `${CLAUDE_PLUGIN_ROOT}/skills/workflow/references/manifest-schema.json` — field definitions
- **Handoff contract**: `${CLAUDE_PLUGIN_ROOT}/skills/workflow/references/handoff-contract.md` — agent transition format
