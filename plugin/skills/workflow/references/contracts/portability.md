...
### Gate System
- Gate catalog: `${CLAUDE_PLUGIN_ROOT}/skills/workflow/references/gates.md`
...
- Required artifacts by profile: `${CLAUDE_PLUGIN_ROOT}/skills/workflow/references/artifact-contract.md`
- Manifest schema: `${CLAUDE_PLUGIN_ROOT}/skills/workflow/references/manifest-schema.json` (schemaVersion: 1)
...
- Check catalog: `${CLAUDE_PLUGIN_ROOT}/skills/workflow/references/hardening-checks.md`
...
|---------|-----------------|---------------------|
| Workflow commands | `~/.claude/commands/taskplex.md` + `${CLAUDE_PLUGIN_ROOT}/skills/workflow/references/` | Equivalent command/skill location |
| Agent definitions | `${CLAUDE_PLUGIN_ROOT}/agents/{agent}.md` | Agent prompt templates |
