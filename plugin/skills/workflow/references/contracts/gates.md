...
Limits are defined in `${CLAUDE_PLUGIN_ROOT}/skills/workflow/references/policy.json` per profile.
...
See `${CLAUDE_PLUGIN_ROOT}/skills/workflow/references/policy.md` → "Invariant Floor" for the full list of non-overridable behaviors.
